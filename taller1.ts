...
// Variables lógicas
let realizandoTaller: boolean = true; // se declara la variable, se le asigna un tipo de dato booleano y se le asigna un valor a la variable.
const seRealizanCuatroTalleresHoy: boolean = false; // se declara la variable, se le asigna un tipo de dato booleano y se le asigna un valor a la variable.

// Variables numéricas
let ejemploEdad: number = 23; // se declara la variable, se le asigna un tipo de dato numerico y se le asigna un valor a la variable.
const año: number = 2024; // se declara la variable, se le asigna un tipo de dato numerico y se le asigna un valor a la variable.

// Variables any - pueden convertirse en otros tipos de datos sin presentar error
let tipoDato: any = "Texto"; // se declara la variable, se le asigna un tipo de dato any y se le asigna un valor a la variable, en este caso queda tipo string.
let anyObjeto: any = { key: "objeto" }; // se declara la variable, se le asigna un tipo de dato any y se le asigna un valor a la variable, en este caso queda tipo objeto.

// Variables string
let primerNombre: string = "Paula"; // se declara la variable, se le asigna un tipo de dato string y se le asigna un valor a la variable 
let primerApellido: string = "Pérez"; // se declara la variable, se le asigna un tipo de dato string y se le asigna un valor a la variable
...
// Array de números
let numeros: number[] = [1, 2, 3, 4, 5]; // se declara la variable, se le asigna un tipo de dato numerico y de tipo array, se le asignan los elementos al array.
...
// Array de strings
let frutas: string[] = ["manzana", "banano", "cereza", "naranja", "kiwi"];// se declara la variable, se le asigna un tipo de dato string y de tipo array, se le asignan los elementos al array.
...
let objetoNumerosTexto: { [key: number]: string } = {
    0: "Cero",
    1: "Uno",
    2: "Dos",
    3: "Tres",
